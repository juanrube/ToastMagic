...
class ToastMagicServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__ . '/config/laravel-toast-magic-8.php' => config_path('laravel-toast-magic-8.php'),
        ]);
    }
    ...
    {
        $configPath = config_path('laravel-toast-magic-8.php');

        if (!file_exists($configPath)) {
            config(['laravel-toast-magic-8' => require __DIR__ . '/config/laravel-toast-magic-8.php']);
        }
    ...
    private function updateProcessingDirectoryConfig(): void
    {
        ...
        config(['laravel-toast-magic-8.system_processing_directory' => $systemProcessingDirectory]);
    }
